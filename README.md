...
Modificado "<p>" añadiendo un estilo css para los p en hero-gigante y su clase<br>
...
Se han eliminado del Header el link de Bootstrap ya que no es necesario y el link de Font Awesome ya que se ha sustituido el icono de este por un emoji
